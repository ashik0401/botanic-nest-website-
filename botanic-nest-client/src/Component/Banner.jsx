                    ...
                    {data.map((item) => (
                        <SwiperSlide key={item.id}>
                            <div className="relative w-full h-[500px]">
                                ...
                                />
                                <div className="absolute inset-0 flex flex-col items-center md:items-start justify-center px-6 text-white bg-black/60 rounded-xl transition-all duration-500 md:pl-40">
